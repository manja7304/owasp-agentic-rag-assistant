...
Security teams face backlog and false-positive fatigue in **OWASP/WSTG policy Q&A**. This repo demonstrates a production-style **Agentic RAG** agent using **LangChain**.

Query rewrite, retrieval grader, and self-correction over OWASP corpus with RAGAS eval.
...
|---------|------------|------------------------|
| Agentic RAG | Core agent flow | Simple prompt chain |
